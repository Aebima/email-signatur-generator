...
```
cd existing_repo
git remote add origin https://gitlab.ost.ch/ifs/ipa/mail-signatur-generator/email-signatur-generator.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ost.ch/ifs/ipa/mail-signatur-generator/email-signatur-generator/-/settings/integrations)
